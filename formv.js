...
var lvaln=document.getElementById("namelogin");
var lvalp=document.getElementById("loginpassw");
var index=0;
var stuarr={};
var stulist=[];
function validation(){
...
function validDetails(){
    ...
    var i=0;
    for(i=0;i<index;i++){
        if(stulist[i].Name==lvaln.value & stulist[i].Password==lvalp.value){
...
function display(){
    var ele=document.getElementById("navitems");
